...
public final class MimeUtils {
    ...
    static {
        ...
        // add("application/x-flac", "flac"); // LEEROYFLIX: use audio/flac
        ...
        add("text/rtf", "rtf");
        //add("text/texmacs", "ts"); // LEEROYFLIX: use video/mp2t
        add("text/text", "phps");
        ...
        // new extensions handled by LEEROYFLIX
        add("audio/amr", "amr");
        add("audio/aac", "aac");
        add("audio/flac", "flac");
        add("audio/mp4", "m4b");
...
//      add("video/ogg", "ogv");
//      add("video/ogg", "ogm");
        add("video/x-ms-wmv", "dvr-ms");
        add("video/x-msvideo", "divx");
        add("video/x-flv", "flv");
        add("video/x-f4v", "f4v");
        ...
        add("video/mpeg", "vob");
        add("video/webm", "webm");
        add("application/aos-update", "aos");
        add("application/fw-update", "img"); // extension for 3rd party fw update files
        add("application/fw-update", "update.zip"); // extension for 3rd party fw update files, must match ZIP_FW_UPDATE_FILE_NAME in FileManagerCore.java
        add("text/plain", "sub");
        ...
        add("video/avos-ac3", "ac3");
        add("video/avos-rca", "rca");
        add("video/avos-rcv", "rcv");
        add("video/avos-gvi", "gvi");
        add("video/avos-vro", "vro");
        add("video/avos-trp", "trp");
        add("video/avos-mts", "mts");
        add("video/avos-m2v", "m2v");
        add("video/avos-264", "264");
        add("video/avos-h264", "h264");
        add("video/avos-mpg4", "mpg4");
        add("video/avos-mpeg4", "mpeg4");
        add("video/avos-yuv", "yuv");
        add("video/avos-amv", "amv");
        add("video/avos-rcrv", "rcrv");
    }
