...
public class ExternalSDFileWriter {
    ...
    public ExternalSDFileWriter(ContentResolver contentResolver, File file) {
        if (log.isDebugEnabled()) log.debug("ExternalSDFileWriter {}", file.getPath());
        this.file = file;
    ...
    public boolean delete() throws IOException {
        ...
        if (file.exists()) {
            ...
            if (log.isDebugEnabled()) log.debug("delete: insert like it was an image imagesUri {}, filesUri {}", imagesUri, filesUri);
